# Make file for the rabbit/4 project...

PROJECT_NAME := RabbIT/4
...
LIBS := $(wildcard $(PROJDIR)/libs/*.jar)
...
help:
	@echo " - $(PROJECT_NAME) somewhat generic Java makefile -"
